...
export async function handler(event, context) {
  const stopTimer = metrics.startTimer("entity.update.api.duration");
  let input;
  ...
  try {
    ...
    logger.error("Unhandled update entity API error", {
    ...
    logger.info("Update entity API handler completed", {
      duration: stopTimer()
    });
    metrics.flush();
  }
