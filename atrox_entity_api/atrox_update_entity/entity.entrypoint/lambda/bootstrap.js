import { UpdateEntityUseCase } from "../../entity.application/use-cases/update-entity.use-case.js";
import { UpdateEntityBatchUseCase } from "../../entity.application/use-cases/update-entity-batch.use-case.js";
...
const singleUseCase = new UpdateEntityUseCase({
  repository,
  logger,
  metrics
});
const batchUseCase = new UpdateEntityBatchUseCase({
  singleUseCase,
  logger,
  metrics
});
