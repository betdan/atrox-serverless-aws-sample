...
export async function handler(event, context) {
  const stopTimer = metrics.startTimer("entity.get.api.duration");
  let input;
  ...
  try {
    ...
    logger.error("Unhandled get entity API error", {
    ...
    logger.info("Get entity API handler completed", {
      duration: stopTimer()
    });
    metrics.flush();
  }
