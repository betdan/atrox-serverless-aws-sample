...
export async function handler(event, context) {
  const stopTimer = metrics.startTimer("entity.create.api.duration");
  let input;
  ...
  try {
    ...
    logger.error("Unhandled create entity API error", {
    ...
    logger.info("Create entity API handler completed", {
      duration: stopTimer()
    });
    metrics.flush();
  }
